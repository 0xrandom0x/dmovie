...
export default {
  ...
  created(){
    this.params.name = this.product.name
    this.params.movieLink = this.product.movieLink
    this.params.imgsrc = this.product.imgsrc
  },
  mounted() {
    this.handleProduct()
    this.date_function();
...
.video-size { width:370px;height:270px; border-radius: 10px; }
.video-position { position: relative; top: -200px; z-index: -1; }
</style>
